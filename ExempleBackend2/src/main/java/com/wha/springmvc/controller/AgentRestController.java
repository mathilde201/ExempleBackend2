...
public class AgentRestController {
	...
	/*
	//------------------update client ------------------------------------------------    
	@RequestMapping(value = "/agent/{idAgent}/updateClient/{idClient}", method = RequestMethod.PUT)
    public ResponseEntity<Void> updateClient(@PathVariable("id") int id, @RequestBody Client client, UriComponentsBuilder ucBuilder) {
        System.out.println("Create client " + client + "associate to  " + id);
	...
	*/
    ...
    public ResponseEntity<Client> updateClient(@PathVariable("idAgent") Long idAgent,@PathVariable("idClient") Long idClient, @RequestBody Client client) {
...
public ResponseEntity<Void> createAgent(@RequestBody Agent agent,    UriComponentsBuilder ucBuilder) {
    System.out.println("Creating User " + agent.getUsername());
